...
![依赖关系](/images/lerna/multiple-projects.png)  
...
假如相互依赖关系如下：  
![依赖](/images/lerna/lerna-dependence.jpg)
...
![output](/images/lerna/lerna-output.jpg)
...
询问版本号界面如下： 
![询问版本号](/images/lerna/lerna-publish3.jpg) 

选择了版本号的下一步界面如下：  
![询问版本下一步](/images/lerna/lerna-publish4.jpg)

我们可以看到三个packages的版本号都统一升级成了`0.1.2`，而且可以看到`feu-app`和`feu-ui`展示为`private`，说明不会被发布到npm。

### 执行结果  

![结果](/images/lerna/lerna-publish-ok.jpg)
